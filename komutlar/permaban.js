    ...
    const ban = async (user, reason) => {
        ...
        try {
            ...
            if (err.code == 50035) {
                ...
                error('+pban "ban", "unban", "liste", "sorgu"');
                console.log(err);
            }
        };
    };
...
exports.conf = {
    enabled: true,
    guildOnly: false,
    aliases: ['açılmayanban', 'aban','pban','permaban','sonsuzban'],
    permLevel: 0
};

exports.help = {
    name: 'açılmayan-ban',
    description: 'Şahıs sonsuza kadar banlanır.'
};
