			...
			while (userHP > 0 && oppoHP > 0) { // eslint-disable-line no-unmodified-loop-condition
				...
				if (choice === 'saldır') {
					...
					if (!miss) {
						...
						await message.channel.send(`${user}, Biriktirdiğin o ultra gücü kullandın ve **${damage}** hasar vurdun!!`);
						dealDamage(damage);
					} else {
						await message.channel.send(`${user}, Maalesef, o biriktirdiğin gücü kullanamadın!`);
					}
					reset();
				} else if (choice === 'kaç') {
